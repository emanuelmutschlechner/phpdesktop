    ...
    switch (uMsg) {
        case WM_SIZE:
            ...
            if (browser && browser->GetCefBrowser()) {
                ...
                PDLOG_WARNING << "WindowProc() WM_SIZE: could not fetch BrowserWindow";
            }
            break;
        case WM_MOVE:
        case WM_MOVING:
        case WM_SIZING:
            ...
            if (browser && browser->GetCefBrowser()) {
                ...
                PDLOG_WARNING << "WindowProc() WM_MOVE: could not fetch BrowserWindow";
            }
            return 0;
        case WM_CREATE:
        ...
        case WM_GETMINMAXINFO:
            ...
            if (browser) {
                ...
                PDLOG_DEBUG << "WindowProc(): event WM_GETMINMAXINFO: "
        ...
        case WM_SETFOCUS:
            ...
            if (browser) {
                ...
                PDLOG_DEBUG << "WindowProc(): event WM_SETFOCUS: "
                             "could not fetch BrowserWindow";
            }
            break;
        case WM_ERASEBKGND:
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance,
    ...
    if (argv) {
        ...
        PDLOG_WARNING << "CommandLineToArgvW() failed";
    }
    ...
    PDLOG_INFO << "--------------------------------------------------------";
    PDLOG_INFO << "Started application";

    if (log_file.length())
        PDLOG_INFO << "Logging to: " << log_file;
    else
        PDLOG_INFO << "No logging file set";
    PDLOG_INFO << "Log level = "
    ...
    if (remote_debugging_port > 0) {
        PDLOG_INFO << "remote_debugging_port = " << remote_debugging_port;
