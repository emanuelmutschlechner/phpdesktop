...
bool StartWebServer() {
    PDLOG_INFO << "Starting PHP built-in web server";
    ...
    PDLOG_INFO << "PHP executable: " << phpExecutable;
    ...
    PDLOG(logDEBUG) << "PHP shell parameters: " << shellParams;
...
void StopWebServer() {
    PDLOG_INFO << "Stopping PHP built-in web server";
